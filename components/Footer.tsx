...
const socialLinks = [
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61584853979616',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@biovitalitylife',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/113119172/',
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
...
export default function Footer() {
  return (
    <footer
      className="pt-10 md:pt-16 pb-6 md:pb-8 px-6"
      style={{ backgroundColor: '#084e46' }}
      aria-label="Site footer"
    >
      <div className="mx-auto max-w-6xl">
        {/* Top grid */}
        <div className="grid gap-6 md:gap-10 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-8 md:mb-12">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-1 text-center md:text-left">
            <Image
              ...
              width={150}
              height={48}
              className="h-12 md:h-10 w-auto object-contain mb-3 mx-auto md:mx-0"
            />
              ...
              {socialLinks.map((s) => (
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full
                             bg-white/10 text-white/70 text-[10px] font-bold
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-bold text-xs md:text-sm mb-2 md:mb-4">Quick Links</h4>
